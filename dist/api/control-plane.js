...
class ControlPlane {
    ...
    connectionPool;
    configEngine;
    constructor(port, connectionPool, configEngine) {
        this.port = port;
    ...
    setupRoutes() {
        ...
        this.app.post('/api/servers/:id/start', async (req, res) => {
            ...
            try {
                ...
                // For now, just log.
                logger_js_1.logger.info({ id }, 'Request to start server');
        ...
        this.app.post('/api/servers/:id/stop', async (req, res) => {
            ...
            logger_js_1.logger.info({ id }, 'Request to stop server');
            res.status(501).json({ error: 'Not implemented yet' });
        });
        // GET /api/logs (SSE)
    ...
    start() {
        this.app.listen(this.port, () => {
            logger_js_1.logger.info({ port: this.port }, 'Control Plane started');
        });
    }
}
